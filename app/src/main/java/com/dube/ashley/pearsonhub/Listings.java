...
public class Listings extends AppCompatActivity {
    ...
    private void loadData(Context mContext, String theSellerNum, final String theEmail)
    {
        ...
        options= new FirebaseRecyclerOptions.Builder<CategoryHandler>().setQuery(FirebaseDatabase.getInstance().getReference("Books").orderByChild("sellerNumber").equalTo(theSellerNum),CategoryHandler.class).build();
        adapter=new FirebaseRecyclerAdapter<CategoryHandler, MyViewHolder>(options)
        {
            ...
            {
                View view= LayoutInflater.from(parent.getContext()).inflate(R.layout.cardview_book_listings,parent,false);
